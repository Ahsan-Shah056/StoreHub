...
class EmployeeUI:
    def __init__(self, master):
        ...
        self.add_employee_role_label = ttk.Label(self.add_tab, text="Role:")
        self.add_employee_role_label.grid(row=1, column=0, sticky=tk.W, padx=2, pady=2)
        self.add_employee_role_entry = ttk.Entry(self.add_tab, width=20)
        self.add_employee_role_entry.grid(row=1, column=1, sticky=tk.W, padx=2, pady=2)
        ...
        self.update_employee_role_label = ttk.Label(self.update_tab, text="Role:")
        self.update_employee_role_label.grid(row=2, column=0, sticky=tk.W, padx=2, pady=2)
        self.update_employee_role_entry = ttk.Entry(self.update_tab, width=20)
        self.update_employee_role_entry.grid(row=2, column=1, sticky=tk.W, padx=2, pady=2)
        ...
        self.employee_tree = ttk.Treeview(self.frame, columns=('ID', 'Name', 'Role'), show='headings', height=10)
